...
export default function HackathonPage() {
    ...
    const writeTimer = setTimeout(() => {
      gsap.fromTo(
        ...
        { clipPath: "inset(0 100% 0 0)" },
        {
          ...
          duration: 2,
          ease: "power2.inOut",
          // Step 3: after writing finishes, jellyfish glow first
          onComplete: () => {
  ...
  return (
    <div className="min-h-screen bg-[#03050a] text-white relative overflow-hidden">
      ...
      <div
        className={`fixed inset-0 bg-black z-40 transition-opacity duration-1000 ${showContent ? 'opacity-0 pointer-events-none' : 'opacity-100'
          }`}
      />
      ...
      <section className="relative overflow-hidden min-h-screen flex items-center">
        ...
        <div
          ...
          style={showJellyfish ? {
            animation: 'jellyfishGlowBlue 1s ease-out forwards, float 6s infinite ease-in-out',
          } : { opacity: 0 }}
        >
          <img
        ...
        <div
          ...
          style={showJellyfish ? {
            animation: 'jellyfishGlowPurple 1s ease-out forwards, floatReverse 9s infinite ease-in-out',
          } : { opacity: 0 }}
        >
          <img
            src="/hackathon/Creature/Jellyfish 1.svg"
        ...
        <div
          className={`absolute top-40 left-1/4 w-[500px] h-[500px] bg-[#91C4E3] blur-[150px] rounded-full transition-opacity duration-1000 ${showContent ? 'opacity-5' : 'opacity-0'
            }`}
        />
        <div
          className={`absolute top-60 right-1/3 w-[400px] h-[400px] bg-[#A594BA] blur-[150px] rounded-full transition-opacity duration-1000 ${showContent ? 'opacity-5' : 'opacity-0'
            }`}
        />
        ...
        <div className="container mx-auto px-4 py-20 pt-36 relative z-50">
          <div className="text-center max-w-4xl mx-auto space-y-4">
            {/* Partner logos */}
            <div
              className={`flex items-center justify-center gap-16 -mt-36 mb-16 transition-opacity duration-1000 ${showContent ? 'opacity-100' : 'opacity-0'
                }`}
            >
        ...
        <div
          className={`absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 z-50 transition-opacity duration-1000 ${showContent ? 'opacity-100' : 'opacity-0'}`}
        >
      ...
      >
        ...
        <section className="py-16 relative z-10">
          {/* Jellyfish decoration */}
          <div className="absolute left-10 top-10 opacity-15 pointer-events-none" style={{ animation: 'float 5s infinite ease-in-out' }}>
            <img src="/hackathon/Creature/Jellyfish 1.svg" alt="" className="w-24 h-24" style={{ filter: 'drop-shadow(0 0 10px rgba(165,148,186,0.4))' }} />
          </div>
