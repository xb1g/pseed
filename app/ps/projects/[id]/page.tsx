...
export default async function ProjectDetailPage({
  ...
  return (
    <div className="min-h-screen bg-background">
      {/* Hero Header */}
      <div className="relative overflow-hidden shadow-lg transition-all duration-500" style={headerStyle}>
        <div className="absolute inset-0 bg-black/20" /> {/* Dim overlay for text readability */}
        <div className="container mx-auto py-12 px-4 relative z-10">
          <Button
            variant="ghost"
            className="mb-8 pl-0 hover:pl-2 text-inherit hover:text-inherit hover:bg-white/10 transition-all"
            asChild
          >
