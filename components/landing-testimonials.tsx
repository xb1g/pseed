...
const content = {
  ...
  th: {
    eyebrow: "นักเรียนจริง ผลลัพธ์จริง",
    title: "ร่วมกับนักเรียน 20+ คนที่ค้นพบเส้นทางของตัวเอง",
    subtitle: "ทุกรายงานทิศทางเล่าเรื่องราวของการค้นพบตัวเอง",
    stats: {
      students: { value: 20, suffix: "+", label: "นักเรียนที่ได้รับคำแนะนำ" },
      paths: { value: 15, suffix: "+", label: "เส้นทางอาชีพที่สำรวจ" },
      schools: { value: 5, suffix: "+", label: "มหาวิทยาลัยพันธมิตร" },
    },
    testimonials: [
      {
        quote: "ฉันคิดว่าอยากเป็นหมอเพราะพ่อแม่บอกมา หลังลอง PathLab ทางการแพทย์ ฉันรู้ว่าฉันรักด้านการวิจัยมากกว่าการดูแลคนไข้ ตอนนี้เล็งไปที่งานวิจัยชีวการแพทย์",
        name: "พิม",
      ...
      {
        quote: "การท้าทาย UX ดีไซน์ 5 วันทำให้ฉันรู้ว่าฉันชอบการแก้ปัญหามากกว่าการวาดรูป ฉันเปลี่ยนจากศิลปะไปสู่ปฏิสัมพันธ์ระหว่างมนุษย์กับคอมพิวเตอร์ และไม่เคยมองย้อนกลับ",
        name: "ต้น",
      ...
      {
        quote: "ฉันตัดสินใจไม่ได้ระหว่างวิศวกรรมกับบริหาร PathLab ช่วยให้ฉันค้นพบการจัดการผลิตภัณฑ์ — ที่ซึ่งฉันได้ใช้ทั้งสองอย่าง ได้ internship เพราะพูดได้ทั้งสองภาษา",
        name: "มิ้นท์",
        school: "KMUTT",
        avatar: "ม",
        color: "from-orange-500/20 to-orange-500/5",
    ...
    badge: "ผู้สำเร็จ PathLab ที่ยืนยันแล้ว",
  },
};
