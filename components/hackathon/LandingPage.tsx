  ...
  useEffect(() => {
    ...
    if (sessionStorage.getItem("hackathon_skip_intro")) {
      ...
      if (subtitleRef.current) {
        gsap.set(subtitleRef.current, { clearProps: "clipPath" });
      }
      return;
    }
    ...
    const writeTimer = setTimeout(() => {
      gsap.fromTo(
        ...
        { clipPath: "inset(0 100% 0 0)" },
        {
          ...
          ease: "power2.inOut",
          onComplete: () => {
            // Remove the clipping mask after reveal so the subtitle glow can render fully.
            gsap.set(subtitleRef.current, { clearProps: "clipPath" });
            setShowJellyfish(true);
      ...
      <div className="min-h-screen bg-[#03050a] text-white relative [overflow:clip]">
        ...
        <style jsx>{`
          ...
          @keyframes jellyfishGlowBlue {
            0% {
              opacity: 0;
              filter: drop-shadow(0 0 80px rgba(145, 196, 227, 1));
            }
            50% {
              opacity: 1;
              filter: drop-shadow(0 0 50px rgba(145, 196, 227, 0.9));
            }
            100% {
              opacity: 1;
              filter: drop-shadow(0 0 20px rgba(145, 196, 227, 0.4));
            }
          }
          @keyframes jellyfishGlowPurple {
            0% {
              opacity: 0;
              filter: drop-shadow(0 0 80px rgba(165, 148, 186, 1));
            }
            50% {
              opacity: 1;
              filter: drop-shadow(0 0 50px rgba(165, 148, 186, 0.8));
            }
            100% {
              opacity: 1;
              filter: drop-shadow(0 0 24px rgba(165, 148, 186, 0.35));
            }
          }
          @keyframes wave1 {
            from {
          ...
          @keyframes shorePulse {
            ...
            100% {
              opacity: 0.55;
              box-shadow:
                0 0 18px 4px rgba(101, 171, 252, 0.35),
                0 0 40px 10px rgba(145, 196, 227, 0.15);
            }
            50% {
              opacity: 1;
              box-shadow:
                0 0 28px 7px rgba(101, 171, 252, 0.65),
                0 0 60px 18px rgba(145, 196, 227, 0.3);
            }
          }
          .w1 {
          ...
          .w2 {
            animation: wave2 7.5s linear infinite;
          }
          .w3 {
            animation: wave3 4.8s linear infinite;
          }
          .shore {
            animation: shorePulse 3.2s ease-in-out infinite;
          }
        `}</style>
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(to bottom, #020C1A 0%, #0A1E38 20%, #122E5A 45%, #1E4A82 70%, #2A62A0 88%, #3A7CC0 100%)",
            overflow: "visible",
          }}
        >
          {/* Internal glow blobs */}
          ...
          {/* Wave 1 — back, slowest */}
          <div
            className="absolute left-0 w1"
            style={{ top: "-130px", width: "200%", height: "130px" }}
          >
            <svg
              ...
              style={{
                ...
                filter: "drop-shadow(0 0 6px rgba(100,160,230,0.5))",
              }}
            >
              <path
                d="M0,65 C120,110 240,20 360,65 C480,110 600,20 720,65 C840,110 960,20 1080,65 C1200,110 1320,20 1440,65 L1440,130 L0,130 Z"
                fill="rgba(70,130,200,0.28)"
              />
            </svg>
            <svg
              viewBox="0 0 1440 130"
          ...
          {/* Wave 2 — middle */}
          <div
            className="absolute left-0 w2"
            style={{ top: "-95px", width: "200%", height: "95px" }}
          >
            <svg
              viewBox="0 0 1440 95"
              preserveAspectRatio="none"
              style={{
                ...
                height: "100%",
                display: "inline-block",
                filter: "drop-shadow(0 0 10px rgba(145,196,227,0.6))",
              }}
            >
              <path
                d="M0,48 C180,85 360,11 540,48 C720,85 900,11 1080,48 C1260,85 1440,11 1440,48 L1440,95 L0,95 Z"
                fill="rgba(101,171,252,0.4)"
              />
            </svg>
            <svg
              viewBox="0 0 1440 95"
          ...
          <div
            className="absolute left-0 w3"
            style={{ top: "-65px", width: "200%", height: "65px" }}
          >
            <svg
              viewBox="0 0 1440 65"
              preserveAspectRatio="none"
              style={{
                ...
                display: "inline-block",
                filter:
                  "drop-shadow(0 0 14px rgba(101,171,252,0.75)) drop-shadow(0 0 30px rgba(145,196,227,0.4))",
              }}
            >
              <path
                d="M0,32 C240,58 480,6 720,32 C960,58 1200,6 1440,32 L1440,65 L0,65 Z"
                fill="rgba(145,196,227,0.6)"
              />
            </svg>
            <svg
              viewBox="0 0 1440 65"
        ...
        <section className="relative overflow-visible min-h-screen flex items-center">
              ...
              showJellyfish
                ? {
                    animation: instant
                      ...
                      : "jellyfishGlowBlue 1s ease-out forwards, float 6s infinite ease-in-out",
                  }
                : { opacity: 0 }
            }
          >
          ...
          <div
            ...
            style={
              showJellyfish
                ? {
                    animation: instant
                      ? "floatReverse 9s infinite ease-in-out"
                      : "jellyfishGlowPurple 1s ease-out forwards, floatReverse 9s infinite ease-in-out",
                  }
                : { opacity: 0 }
            }
          >
          ...
          <div className="container mx-auto px-4 py-20 pt-36 relative z-50">
            <div className="text-center max-w-4xl mx-auto space-y-4">
              ...
              <div
                className={`relative z-50 flex justify-center overflow-visible px-6 py-4 -mx-6 -my-4 ${showTitle ? (instant ? "opacity-100" : "animate-titleGlowUp") : "opacity-0"}`}
              >
                <img
                  ...
                  style={{
                    filter:
                      "drop-shadow(0 0 55px rgba(145,196,227,0.45)) drop-shadow(0 0 24px rgba(145,196,227,0.35))",
                  }}
                />
              </div>
        ...
        >
          ...
          <section className="py-20 relative z-10 overflow-hidden">
            ...
            <div
              className="absolute right-16 top-1/4 opacity-15 pointer-events-none"
              style={{ animation: "floatReverse 9s infinite ease-in-out" }}
            >
              <img
                src="/hackathon/Creature/Jellyfish 1.svg"
                alt=""
                className="w-44 h-44"
                style={{
                  filter: "drop-shadow(0 0 16px rgba(145,196,227,0.4))",
                  transform: "scaleX(-1)",
                }}
              />
            </div>
                ...
                <div className="space-y-6">
                  <div className="mb-12">
                    <p className="text-gray-200 text-lg md:text-xl leading-relaxed text-center">
                      ที่ The Next Decade Hackathon 2026{" "}
                      <span className="text-[#91C4E3] font-semibold">
                        พื้นฐานไม่ใช่ข้อจำกัด แต่คือจุดเริ่มต้นของการเรียนรู้
                      </span>{" "}
                      เราเปลี่ยนพื้นที่แข่งขันให้กลายเป็นโอกาสให้คุณได้ทดลอง
                      สร้างสรรค์ และเรียนรู้จากการลงมือทำจริงได้แบบไม่ต้องกังวล
                      ผ่านระบบเหล่านี้:
                    </p>
                  </div>
                  ...
                  <div className="bg-[#0d1219]/70 backdrop-blur-md p-6 md:p-8 rounded-3xl border border-[#91C4E3]/20 shadow-[0_0_40px_rgba(145,196,227,0.08)] hover:border-[#91C4E3]/40 transition-all duration-500 max-w-4xl mx-auto w-full">
                    <div className="flex flex-col md:flex-row items-center gap-4 md:gap-6">
                      ...
                      <div className="flex-1 text-center md:text-left">
                        <h4 className="text-[#91C4E3] font-semibold text-xl md:text-2xl mb-3">
                          Personal Mentorship
                        </h4>
                        <p className="text-gray-300 text-base md:text-lg leading-relaxed">
                          เรามีการจัดสรร Mentor
                          ประจำแต่ละกลุ่มเพื่อคอยให้คำปรึกษาและ Feedback
                          อย่างใกล้ชิด
                          พี่ๆจะช่วยให้คำแนะนำและดูแลให้น้องๆมือใหม่ยังคงอยู่ในเส้นทางและพัฒนาไอเดียได้อย่างเต็มศักยภาพ
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-[#0d1219]/70 backdrop-blur-md p-6 md:p-8 rounded-3xl border border-[#A594BA]/20 shadow-[0_0_40px_rgba(165,148,186,0.08)] hover:border-[#A594BA]/40 transition-all duration-500 max-w-4xl mx-auto w-full">
                    <div className="flex flex-col md:flex-row items-center gap-4 md:gap-6">
                      ...
                      <div className="flex-1 text-center md:text-left">
                        <h4 className="text-[#A594BA] font-semibold text-xl md:text-2xl mb-3">
                          Learning Guideline
                        </h4>
                        <p className="text-gray-300 text-base md:text-lg leading-relaxed">
                          คุณจะได้เรียนรู้กระบวนการสร้างนวัตกรรมอย่างเป็นระบบผ่านหลักสูตร{" "}
                          <span className="text-[#A594BA] font-semibold">
                            Design Thinking
                          </span>{" "}
                          ที่มุ่งเน้นการลงมือทำจริงเพื่อให้ได้ผลงานที่ใช้งานได้จริง
                          (Functional Prototype) และมีเว็บคอย guide
                          ทางให้ในแต่ละขั้นตอน
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-[#0d1219]/70 backdrop-blur-md p-6 md:p-8 rounded-3xl border border-[#91C4E3]/20 shadow-[0_0_40px_rgba(145,196,227,0.08)] hover:border-[#91C4E3]/40 transition-all duration-500 max-w-4xl mx-auto w-full">
                    <div className="flex flex-col md:flex-row items-center gap-4 md:gap-6">
                      ...
                      <div className="flex-1 text-center md:text-left">
                        ...
                        <p className="text-gray-300 text-base md:text-lg leading-relaxed">
                          หัวใจสำคัญคือการนำ Prototype ไปทดลองใช้จริง เพื่อรับ
                          Feedback มาพัฒนาผลงานให้แม่นยำ
                          ขั้นตอนนี้จะช่วยสร้างความมั่นใจว่าสิ่งที่คุณสร้างขึ้นนั้นสามารถแก้ปัญหาได้ตรงจุดและตอบโจทย์คนใช้งานจริง
          ...
          <section className="py-32 relative z-10 overflow-hidden">
            ...
            <div
              className="absolute right-1/4 top-1/3 opacity-15 pointer-events-none"
              style={{ animation: "floatReverse 7s infinite ease-in-out" }}
            >
              <img
                src="/hackathon/Creature/Jellyfish 1.svg"
                alt=""
                className="w-36 h-36"
                style={{
                  filter: "drop-shadow(0 0 12px rgba(145,196,227,0.4))",
                  transform: "scaleX(-1)",
                }}
              />
            </div>
                    ...
                    <div className="relative bg-gradient-to-br from-[#0d1219]/95 to-[#0a0f16]/95 backdrop-blur-xl rounded-3xl border border-[#91C4E3]/30 p-10 md:p-12 group-hover:border-[#91C4E3]/50 transition-all duration-500 h-full">
                      ...
                      <div className="mb-8 flex items-center justify-center">
                        <div className="relative">
                          ...
                          <UsersRound
                            className="w-20 h-20 text-[#91C4E3] relative z-10"
                            strokeWidth={1.5}
                          />
                        </div>
                      </div>
                      ...
                      {/* Title */}
                      <h3
                        className="text-3xl md:text-4xl font-bold text-[#91C4E3] mb-8 text-center"
                        style={{
                      ...
                      <div className="space-y-6">
                        <div className="flex flex-col gap-4">
                          ...
                          <div className="relative group/item">
                            <div className="absolute -left-3 top-1/2 -translate-y-1/2 w-1.5 h-1.5 rounded-full bg-[#91C4E3] opacity-0 group-hover/item:opacity-100 transition-opacity" />
                            <p className="text-lg md:text-xl text-[#91C4E3] font-medium text-center group-hover/item:translate-x-2 transition-transform">
                              Track 2: ระดับมหาวิทยาลัย (ปริญญาตรี - ปริญญาเอก)
                              หรือเทียบเท่า (ปวส.)
                            </p>
                          </div>
                        </div>
                    ...
                    <div className="relative bg-gradient-to-br from-[#0d1219]/95 to-[#0a0f16]/95 backdrop-blur-xl rounded-3xl border border-[#A594BA]/30 p-10 md:p-12 group-hover:border-[#A594BA]/50 transition-all duration-500 h-full">
                      ...
                      <div className="mb-8 flex items-center justify-center">
                        <div className="relative">
                          ...
                          <UsersRound
                            className="w-20 h-20 text-[#A594BA] relative z-10"
                            strokeWidth={1.5}
                          />
                        </div>
                      </div>
                      ...
                      {/* Title */}
                      <h3
                        className="text-3xl md:text-4xl font-bold text-[#A594BA] mb-8 text-center"
                        style={{
          ...
          <section className="py-32 relative z-10">
            <div className="container mx-auto px-4 relative z-10">
              <h2 className="text-5xl md:text-6xl font-bold mb-20 text-center">
                <span className="text-white/90">Tracks</span>
              </h2>
              ...
              <div className="max-w-7xl mx-auto space-y-2">
                ...
                <div
                  onClick={() =>
                    setExpandedTrack(expandedTrack === 1 ? null : 1)
                  }
                ...
                >
                  <div className="flex items-center justify-between gap-8 md:gap-12 p-8 md:p-12">
                    <div className="flex items-center gap-8 md:gap-12 flex-1">
                      ...
                      <div className="flex-shrink-0 flex items-center gap-6">
                        ...
                        <HeartPulse
                          className="w-12 h-12 md:w-16 md:h-16 text-[#91C4E3] transition-all duration-500"
                          strokeWidth={1}
                        />
                      </div>
                    ...
                    {/* Arrow indicator */}
                    <div
                      className={`flex-shrink-0 text-white/20 group-hover:text-[#91C4E3] transition-all duration-300 ${expandedTrack === 1 ? "rotate-90" : ""}`}
                    >
                      <svg
                        width="24"
                        height="24"
                  ...
                  <div
                    className={`overflow-hidden transition-all duration-700 ease-out ${expandedTrack === 1 ? "max-h-96" : "max-h-0"}`}
                  >
                  ...
                  {/* Bottom border */}
                  <div
                    className={`h-px bg-gradient-to-r from-transparent to-transparent transition-colors duration-500 ${expandedTrack === 1 ? "via-[#91C4E3]/40" : "via-white/5 group-hover:via-[#91C4E3]/40"}`}
                  />
                </div>
                ...
                <div
                  onClick={() =>
                    setExpandedTrack(expandedTrack === 2 ? null : 2)
                  }
                ...
                >
                  <div className="flex items-center justify-between gap-8 md:gap-12 p-8 md:p-12">
                    <div className="flex items-center gap-8 md:gap-12 flex-1">
                      ...
                      <div className="flex-shrink-0 flex items-center gap-6">
                        ...
                        <Brain
                          className="w-12 h-12 md:w-16 md:h-16 text-[#A594BA] transition-all duration-500"
                          strokeWidth={1}
                        />
                      </div>
                    ...
                    {/* Arrow indicator */}
                    <div
                      className={`flex-shrink-0 text-white/20 group-hover:text-[#A594BA] transition-all duration-300 ${expandedTrack === 2 ? "rotate-90" : ""}`}
                    >
                      <svg
                        width="24"
                        height="24"
                  ...
                  {/* Details - Hidden by default, shown on click */}
                  <div
                    className={`overflow-hidden transition-all duration-700 ease-out ${expandedTrack === 2 ? "max-h-96" : "max-h-0"}`}
                  >
                    <div className="px-8 md:px-12 pb-8">
                      <ul className="space-y-2 text-gray-400 text-sm md:text-base ml-[7rem] md:ml-[10rem]">
                        <li className="flex items-start gap-2">
                  ...
                  {/* Bottom border */}
                  <div
                    className={`h-px bg-gradient-to-r from-transparent to-transparent transition-colors duration-500 ${expandedTrack === 2 ? "via-[#A594BA]/40" : "via-white/5 group-hover:via-[#A594BA]/40"}`}
                  />
                </div>
                ...
                <div
                  onClick={() =>
                    setExpandedTrack(expandedTrack === 3 ? null : 3)
                  }
                  className="group relative cursor-pointer transition-all duration-500 ease-out hover:bg-[#91C4E3]/5 rounded-2xl"
                >
                  <div className="flex items-center justify-between gap-8 md:gap-12 p-8 md:p-12">
                    ...
                    {/* Arrow indicator */}
                    <div
                      className={`flex-shrink-0 text-white/20 group-hover:text-[#91C4E3] transition-all duration-300 ${expandedTrack === 3 ? "rotate-90" : ""}`}
                    >
                      <svg
                        width="24"
                        height="24"
                  ...
                  {/* Details - Hidden by default, shown on click */}
                  <div
                    className={`overflow-hidden transition-all duration-700 ease-out ${expandedTrack === 3 ? "max-h-96" : "max-h-0"}`}
                  >
                    <div className="px-8 md:px-12 pb-8">
                      <ul className="space-y-2 text-gray-400 text-sm md:text-base ml-[7rem] md:ml-[10rem]">
                        <li className="flex items-start gap-2">
                  ...
                  {/* Bottom border */}
                  <div
                    className={`h-px bg-gradient-to-r from-transparent to-transparent transition-colors duration-500 ${expandedTrack === 3 ? "via-[#91C4E3]/40" : "via-white/5 group-hover:via-[#91C4E3]/40"}`}
                  />
                </div>
              </div>
            </div>
          ...
          <section className="py-20 relative z-10">
            <div
              className="absolute left-1/4 top-1/3 opacity-15 pointer-events-none"
              style={{ animation: "float 9s infinite ease-in-out" }}
            >
              <img
                src="/hackathon/Creature/Jellyfish 1.svg"
                alt=""
                className="w-32 h-32"
                style={{
                  filter: "drop-shadow(0 0 12px rgba(165,148,186,0.4))",
                }}
              />
            </div>
              ...
              <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
                ...
                <div className="group relative overflow-hidden bg-gradient-to-br from-[#0d1219]/90 to-[#121c29]/80 backdrop-blur-xl rounded-3xl border border-[#91C4E3]/20 p-8 md:p-10 hover:border-[#91C4E3]/50 transition-all duration-500 hover:shadow-[0_0_40px_rgba(145,196,227,0.15)] flex flex-col md:col-span-2 lg:col-span-3">
                  ...
                  <h3 className="text-2xl md:text-3xl font-bold text-white mb-4 tracking-wide">
                    Health & Tech Workshops
                  </h3>
                  <p className="text-gray-300 leading-relaxed text-lg flex-1">
                    Workshops ที่ช่วยให้เข้าใจปัญหาสุขภาพจริง ตั้งแต่{" "}
                    <span className="text-[#91C4E3] font-semibold">
                      problem discovery → research → prototyping
                    </span>
                  </p>
                </div>
                {/* Card 2: Square */}
                ...
                <div className="group relative overflow-hidden bg-gradient-to-tl from-[#0d1219]/90 to-[#161423]/80 backdrop-blur-xl rounded-3xl border border-[#A594BA]/20 p-8 md:p-10 hover:border-[#A594BA]/50 transition-all duration-500 hover:shadow-[0_0_40px_rgba(165,148,186,0.15)] flex flex-col md:col-span-2 lg:col-span-3">
                  ...
                  <p className="text-gray-300 leading-relaxed text-lg flex-1">
                    Mentorship และ feedback จากผู้เชี่ยวชาญด้าน{" "}
                    <span className="text-[#A594BA] font-semibold">
                      health, tech และ business
                    </span>
                  </p>
                </div>
              </div>
          ...
          <section className="py-24 relative z-10">
            <div
              ...
              style={{ animation: "floatReverse 11s infinite ease-in-out" }}
            >
              <img
                src="/hackathon/Creature/Jellyfish 1.svg"
                alt=""
                className="w-40 h-40"
                style={{
                  filter: "drop-shadow(0 0 16px rgba(165,148,186,0.5))",
                  transform: "scaleX(-1)",
                }}
              />
            </div>
            ...
            <div className="container mx-auto px-4 relative z-10">
              <div className="text-center mb-16">
                <h2
                  ...
                  style={{ textShadow: "0 0 40px rgba(165,148,186,0.4)" }}
                >
                  <span className="bg-gradient-to-r from-[#91C4E3] to-[#A594BA] bg-clip-text text-transparent">
                    Beyond the Hackathon
                  </span>
                ...
                <p className="text-xl md:text-2xl text-gray-300 max-w-3xl mx-auto flex flex-col md:inline-block">
                  ...
                  <span className="text-[#91C4E3] whitespace-nowrap">
                    แต่ต่อยอดสู่การพัฒนาในโลกจริง
                  </span>
                </p>
              </div>
              ...
              <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-8">
                {[
                  ...
                  <div
                    key={idx}
                    className="group relative bg-[#0d1219]/60 backdrop-blur-xl border border-white/5 p-10 rounded-3xl hover:bg-[#0d1219]/80 hover:border-[#91C4E3]/30 transition-all duration-700 hover:-translate-y-2 hover:shadow-[0_20px_40px_rgba(145,196,227,0.1)] flex flex-col items-center text-center"
                  >
          ...
          <section className="py-32 relative z-10 overflow-hidden flex items-center justify-center min-h-[60vh]">
            ...
            <div
              className="absolute right-20 bottom-1/4 opacity-15 pointer-events-none"
            ...
            >
              <img
                ...
                className="w-48 h-48"
                style={{
                  filter: "drop-shadow(0 0 18px rgba(145,196,227,0.5))",
                  transform: "scaleX(-1)",
                }}
              />
            </div>
                ...
                <div className="relative bg-[#EADDCD] text-gray-900 rounded-b-[2.5rem] p-10 md:p-12 pt-14 flex flex-col gap-8 z-10">
                  ...
                  <div className="mt-2 text-center px-4">
                    <p className="text-[#475569] font-medium leading-[1.8] text-sm md:text-[15px]">
                      พื้นที่ที่ผลงานไม่ได้จบลงที่การแข่งขัน ทุกทีมสามารถนำเสนอ
                      prototype
                      <br className="hidden md:block" /> แลกเปลี่ยนแนวคิด
                      และเชื่อมต่อกับนักวิจัย เพื่อต่อยอดในโลกจริง
                    </p>
                  </div>
                </div>
              </div>
          ...
          <section className="py-20 relative z-10">
            <div
              className="absolute right-1/4 bottom-10 opacity-15 pointer-events-none"
              style={{ animation: "floatReverse 6s infinite ease-in-out" }}
            >
              <img
                src="/hackathon/Creature/Jellyfish 1.svg"
                alt=""
              ...
              <div className="max-w-7xl mx-auto grid md:grid-cols-3 gap-12">
                  ...
                  <div className="flex flex-col items-center text-center gap-6">
                    <div className="flex-shrink-0 group-hover:scale-105 transition-transform duration-300">
                      <img
                        ...
                        style={{
                          filter: "drop-shadow(0 0 12px rgba(145,196,227,0.3))",
                        }}
                      />
                    </div>
                    <div className="flex-1">
                      <h3 className="text-2xl font-bold text-[#91C4E3] mb-3">
                        AMSA Thailand
                      </h3>
                      <p className="text-gray-300 leading-relaxed text-sm">
                        เครือข่ายนักศึกษาแพทย์ที่ทำงานด้านสาธารณสุข
                        การแลกเปลี่ยนความรู้ และความร่วมมือด้านสุขภาพ
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="group bg-[#0d1219]/80 backdrop-blur-md rounded-3xl border border-[#A594BA]/25 p-8 hover:border-[#A594BA]/40 transition-all duration-500 hover:shadow-[0_0_45px_rgba(165,148,186,0.2)] flex flex-col">
                  <div className="flex flex-col items-center text-center gap-6">
                    <div className="flex-shrink-0 group-hover:scale-105 transition-transform duration-300">
                      <img
                        src="/hackathon/PS.png"
                        alt="Passionseed"
                        className="w-24 h-24 object-contain"
                        style={{
                          filter: "drop-shadow(0 0 12px rgba(165,148,186,0.3))",
                        }}
                      />
                    </div>
                    <div className="flex-1">
                      ...
                      <p className="text-gray-300 leading-relaxed text-sm">
                        องค์กรที่พัฒนาเยาวชนผ่านการเรียนรู้ด้านเทคโนโลยี เช่น AI
                        การสร้างผลิตภัณฑ์ดิจิทัล และนวัตกรรม
                        เพื่อสร้างโปรเจกต์ที่ใช้ได้จริง
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="group bg-[#0d1219]/80 backdrop-blur-md rounded-3xl border border-[#91C4E3]/25 p-8 hover:border-[#91C4E3]/40 transition-all duration-500 hover:shadow-[0_0_45px_rgba(145,196,227,0.2)] flex flex-col">
                  <div className="flex flex-col items-center text-center gap-6">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-gray-300 leading-relaxed text-sm">
                        องค์กรนักศึกษาที่สนับสนุนและสร้างแรงบันดาลใจให้ผู้หญิงและเยาวชนในสาย
                        STEM
                      </p>
                    </div>
                  </div>
          ...
          <section className="py-20 relative z-10">
            <div className="container mx-auto px-4 text-center">
              <h2
                ...
                style={{ textShadow: "0 0 30px rgba(165,148,186,0.3)" }}
              >
                <span className="bg-gradient-to-r from-[#A594BA] to-[#91C4E3] bg-clip-text text-transparent">
                  Our Sponsors
                </span>
              </h2>
              <p className="text-gray-300 text-lg mb-10 max-w-2xl mx-auto">
                Partner with us to empower the next generation of innovators.
                Discover how your organization can make an impact.
              </p>
              <Link href="/hackathon/sponsorship">
                <Button
                  variant="outline"
                  size="lg"
                  className="border-[#A594BA]/50 text-[#A594BA] hover:bg-[#A594BA]/10 hover:text-white text-lg px-10 py-6 rounded-full transition-all duration-300"
                >
          ...
          <section className="py-24 relative z-10">
            ...
            <div
              className="absolute top-10 right-1/3 opacity-20 pointer-events-none"
            ...
            >
              <img
                ...
                className="w-52 h-52"
                style={{
                  filter: "drop-shadow(0 0 20px rgba(165,148,186,0.4))",
                }}
              />
            </div>
