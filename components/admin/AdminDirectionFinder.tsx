...
import {
  getAllDirectionFinderResults,
  deleteDirectionFinderResult,
  DirectionFinderResultRow,
} from "@/app/actions/admin/direction-finder";
import {
  Sheet,
  SheetContent,
  SheetDescription,
...
export function AdminDirectionFinder() {
  ...
  const loadData = async () => {
    try {
      setLoading(true);
      const data = await getAllDirectionFinderResults();
      setResults(data);
    } catch (error) {
      console.error("Error loading results:", error);
      toast({
        title: "Error",
        description: "Failed to load direction finder results",
        variant: "destructive",
      });
    } finally {
      setLoading(false);
  ...
  const handleDelete = async (id: string) => {
    ...
    try {
      await deleteDirectionFinderResult(id);
      toast({
        title: "Success",
      ...
      <Card>
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              <CardTitle>Direction Finder Results</CardTitle>
              <CardDescription>
                View and manage AI assessment results and chat history.
              </CardDescription>
            </div>
            <Button
              variant="outline"
        ...
        <CardContent>
          <div className="flex items-center gap-2 mb-4">
            ...
            <Input
              placeholder="Search by user, chat content, or results..."
              value={searchTerm}
              ...
              <Tabs defaultValue="summary" className="h-full flex flex-col">
                <div className="px-6 pt-4">
                  <TabsList>
                    ...
                    <TabsTrigger value="full-data">Full JSON</TabsTrigger>
                  </TabsList>
                </div>
                ...
                >
                  <pre className="mt-4 p-4 rounded-lg bg-slate-950 text-xs overflow-auto font-mono text-slate-300">
