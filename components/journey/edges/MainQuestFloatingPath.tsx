/**
 * MainQuestFloatingPath - Animated floating edge for main quest connections
 * Features gradient styling, pulse animation, and dynamic connection points
 */
...
export function MainQuestFloatingPath({
  id,
  source,
  target,
  markerEnd,
