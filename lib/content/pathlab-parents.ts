...
export const PARENTS_PRICE = {
  ...
  tiers: [
    {
      label: "รอบเต็ม (โปรพิเศษเดือน ส.ค. Beta Launch)",
      amount: "299",
      originalAmount: "699",
      unit: "ต่อคน · รอบ 4-5 วัน (ราคาปกติ 699 บาท)",
      blurb: "ราคาพิเศษเฉพาะเดือนสิงหาคมช่วงทดสอบระบบ Beta มาคนเดียวได้ ทีมจัดกลุ่มและ mentor ให้ใกล้ชิด",
      perks: [
        "+ ฟรี สิทธิ์เข้า Project Community 1 เดือน (มูลค่า 679 บาท)",
  ...
  notes: [
    "ราคาพิเศษ 299 บาท (จากปกติ 699 บาท) เฉพาะช่วงทดสอบระบบ Beta ในเดือนสิงหาคมนี้",
    "รวมสิทธิ์เข้า Project Community 1 เดือน (มูลค่า 679 บาท) และซ้อมสัมภาษณ์พอร์ตกับ Mentor ฟรี",
    "จ่ายครั้งเดียวจบทั้งรอบ ไม่มีค่าใช้จ่ายต่อเนื่องและไม่มีการตัดเงินอัตโนมัติ",
    "ทีมจะจัดกลุ่มและหาเวลาที่ทุกคนตรงกันให้ พร้อม mentor ดูแลใกล้ชิด",
