...
const PATHLAB_SIGNALS = [
  ...
  /อยากลงมือทำ/, /ควรเริ่มตรงไหน/, /อยากทำโปรเจกต์/, /เอาค่ะ/, /เอาครับ/, /สนใจค่ะ/, /สนใจครับ/,
  /อยากได้วิธี/, /เอาด้วย/, /ขอแผน/,
];
...
const INTEREST_KEYWORDS: { pattern: RegExp; label: string }[] = [
  ...
  { pattern: /แพทย|แพทย์|หมอ/, label: "แพทยศาสตร์" },
  { pattern: /ทันต|ทันตะ/, label: "ทันตแพทยศาสตร์" },
  { pattern: /เภสัช/, label: "เภสัชศาสตร์" },
  { pattern: /สัตว|สัตวะ/, label: "สัตวแพทยศาสตร์" },
  { pattern: /พยาบาล/, label: "พยาบาลศาสตร์" },
  { pattern: /พาราเมดิก/, label: "พาราเมดิก" },
  { pattern: /สายสุขภาพ|วิทย์สุขภาพ|วิทยาศาสตร์สุขภาพ/, label: "วิทยาศาสตร์สุขภาพ" },
  { pattern: /วิศว(?:กรรม)?คอม|cecs|วิศวะคอม/i, label: "วิศวกรรมคอมพิวเตอร์" },
  { pattern: /วิศว(?:กรรม)?ไฟฟ้า/, label: "วิศวกรรมไฟฟ้า" },
  { pattern: /วิศว(?:กรรม)?(?:ศาสตร์)?|วิศวะ/, label: "วิศวกรรมศาสตร์" },
  ...
  { pattern: /บริหารธุรกิจ|บริหาร|bba/i, label: "บริหารธุรกิจ" },
  { pattern: /เศรษฐศาสตร์/, label: "เศรษฐศาสตร์" },
  { pattern: /สถาปัตย|สถาปัตย์/, label: "สถาปัตยกรรมศาสตร์" },
  { pattern: /ท่องเที่ยว|โรงแรม/, label: "การท่องเที่ยวและการโรงแรม" },
  { pattern: /วิทยาการคอมพิวเตอร์|programming|เขียนโปรแกรม|วิทยาการคอม/i, label: "วิทยาการคอมพิวเตอร์" },
